...
geo2d::Point Unit::get() const { return _geometry; }
...
bool Unit::CollideWith(const Unit& that) const {
    return geo2d::Collide(get(), that.get());
}
...
geo2d::Rectangle Building::get() const { return _geometry; }
...
geo2d::Circle Tower::get() const { return _geometry; }
...
geo2d::Segment Fence::get() const { return _geometry; }
